 ...
 *  20 = netmirror
 *
 * The config mask is a 21-character string of '0' or '1'.
 * '1' means enabled, '0' means disabled.
 * "111111111111111111111" = all providers enabled (default).
 */
...
export const ALL_PROVIDERS_MASK = "111111111111111111111";
