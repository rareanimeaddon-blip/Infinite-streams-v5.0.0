 ...
 *  19 = hdhub4u
 *
 * The config mask is a 20-character string of '0' or '1'.
 * '1' means enabled, '0' means disabled.
 * "11111111111111111111" = all providers enabled (default).
 */
...
export const ALL_PROVIDERS_MASK = "11111111111111111111";
